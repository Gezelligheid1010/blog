...
CREATE TABLE `comment` (
                           ...
                           `post_id` BIGINT UNSIGNED NOT NULL COMMENT '关联的帖子或文章ID',
                           `author_id` BIGINT UNSIGNED NOT NULL COMMENT '作者的用户ID',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 95519300911105, '胡超', '313233f5d77a10ae47e3738837865e6a831793', NULL, 0, 'https://s2.loli.net/2024/10/23/Mz63sde9upDIoWi.png', '2022-02-09 23:48:53', '2022-02-09 23:48:53');
INSERT INTO `user` VALUES (2, 166698938269697, '胡超超', '313233f5d77a10ae47e3738837865e6a831793', NULL, 0, 'https://s2.loli.net/2024/10/23/Mz63sde9upDIoWi.png', '2022-02-10 11:36:00', '2022-02-10 11:36:00');
