...
<!--			<el-avatar src="https://s2.loli.net/2024/10/23/Mz63sde9upDIoWi.png"></el-avatar>-->
...
<!--					<span>关于我</span>-->
<!--				</div>-->
<!--				&lt;!&ndash; v-for="o in 1" :key="o"  &ndash;&gt;-->
<!--				<div class="text item">-->
<!--					如果没有奇迹，那就去创造！-->
<!--				</div>-->
<!--			</el-card>-->
...
export default {
	...
	data() {
      ...
      userAvatarUrl: null  // 存储用户头像 URL
		};
	},
  created() {
    // 从 localStorage 中读取用户头像 URL
    const userData = JSON.parse(localStorage.getItem('loginResult'));
    console.log("userData:",userData)
    if (userData && userData.avatarImageUrl) {
      this.userAvatarUrl = userData.avatarImageUrl;
    }
